      ...
      <div style={{
            ...
            <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%' }}>
              {STARS.map((s, i) => (
                <circle key={i} cx={`${s.x}%`} cy={`${s.y}%`} r={s.r} fill="#a5f3fc"
                  style={{
                    animation: `um-twinkle ${s.dur}s ease-in-out infinite`,
        ...
        {!dark && (
          <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden' }}>
            <svg style={{
              position: 'absolute', top: '-5%', right: '-8%', width: 380, height: 380,
            ...
            <svg style={{
              position: 'absolute', bottom: '-8%', left: '-5%', width: 320, height: 320,
            ...
            <svg style={{
              position: 'absolute', top: '30%', left: '-3%', width: 200, height: 200,
